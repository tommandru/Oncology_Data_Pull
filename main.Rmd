...
update_query <- glue("CREATE TABLE ONCOLOGY_ACCESS_TEST AS 
...
update_columns_ethnicity <- glue("UPDATE ONCOLOGY_ACCESS_TEST
   SET ETHNICITY_GROUPER = NVL(ETHNICITY_GROUPER, 'UNKNOWN')
 WHERE ETHNICITY IS NULL;")

update_columns_race <- glue("UPDATE ONCOLOGY_ACCESS_TEST
