...
FROM( 
        ...
        a.PAT_ID,
        c.INPERSONVSTELE, d.DISEASE_GROUP, d.DISEASE_GROUP_B AS DISEASE_GROUP_DETAIL, e.*, i.ETHNICITY, i.RACE,
        ...
        LEFT JOIN ONCOLOGY_RACE_GROUPER j on g.RACE = j.RACE
        LEFT JOIN ONCOLOGY_ETHNICITY_GROUPER m on g.ETHNICITY = m.ETHNIC_BACKGROUND
    ) h 
WHERE h.Counts = 1")
